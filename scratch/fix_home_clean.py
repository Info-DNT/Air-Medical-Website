...
def fix_root_files():
    ...
    for file_path in root_files:
        try:
            ...
            # Replace logo link
            new_content = content.replace('class="navbar-brand" href="index.html"', 'class="navbar-brand" href="./"')
            # Replace home link
            new_content = new_content.replace('href="index.html" class="nav-item nav-link">Home</a>', 'href="./" class="nav-item nav-link">Home</a>')
